...
We validated epistract across five drug discovery domains, each backed by a curated corpus of 15--16 PubMed abstracts.
...
\begin{table}[t]
\centering
\caption{Evaluation scenarios. Each row reports the number of input documents, extracted graph statistics, and user acceptance test (UAT) pass rate. All 19 UATs passed.}
\label{tab:scenarios}
\begin{tabular}{cllrrrrr}
\toprule
\textbf{\#} & \textbf{Domain} & \textbf{Focus} & \textbf{Docs} & \textbf{Nodes} & \textbf{Links} & \textbf{Comm.} & \textbf{UATs} \\
\midrule
1 & Neurogenetics       & PICALM / Alzheimer's target validation         & 15 & 149 & 457 & 6 & 4/4 \\
2 & Oncology            & KRAS G12C inhibitor landscape                   & 16 & 108 & 307 & 4 & 5/5 \\
3 & Rare Disease        & PKU, achondroplasia, NPC therapeutics            & 15 &  94 & 229 & 4 & 3/3 \\
4 & Immuno-Oncology     & Checkpoint inhibitor combinations                & 16 & 132 & 361 & 5 & 4/4 \\
5 & CV / Inflammation   & Mavacamten (HCM) + Deucravacitinib (psoriasis)  & 15 &  94 & 246 & 5 & 3/3 \\
\midrule
  & \textbf{Total}      & 5 domains                                        & 77 & 577 & 1{,}600 & 24 & 19/19 \\
\bottomrule
\end{tabular}
\end{table}
