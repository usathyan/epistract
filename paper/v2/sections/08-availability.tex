...
The framework documents two classes of gap explicitly. (A third gap -- fda-product-labels showcase corpus, formerly Issue~\#14 -- closed in v3.2.1 when the S8 SPL corpus landed.)
